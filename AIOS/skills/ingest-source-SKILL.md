...
- **Workflow visualisations** — where the video describes a process, architecture, progression, or decision tree, include an ASCII diagram showing the flow. Only where a visual genuinely clarifies the structure better than prose — don't overdo it.
...
5. **Update this skill file** if the corrections reveal a gap in the process
